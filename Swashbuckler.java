...
public class Swashbuckler extends Warrior {
	Random rand;
	

	public Swashbuckler(String name,Team team) {
		super(name,team);
		rand=new Random();
	}
	...
	public void eulogy() {
		...
		System.out.println("    A vigorous warrior who fought " + getBattles() + " battles, and won " + getBattlesWon() + " of them!");
